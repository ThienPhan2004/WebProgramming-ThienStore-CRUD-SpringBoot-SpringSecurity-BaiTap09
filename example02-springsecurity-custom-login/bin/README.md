# Custom Login — Spring Boot 4 + Spring Security 7 + MapStruct + Thymeleaf + MySQL (không dùng Lombok)

Dự án hoàn chỉnh dựa trên tài liệu hướng dẫn đính kèm, đã chuyển sang **MySQL** và bỏ hoàn toàn **Lombok**
(mọi getter/setter/constructor/builder được viết thủ công).
...
- **Bỏ Lombok**: `Role`, `User`, `UserDTO`, `CustomUserDetails`, `CustomUserDetailsService`, `SecurityConfig`
